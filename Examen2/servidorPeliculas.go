...
func server(){
	...
	rpc.Register(new(ServerJ))
	s,err := net.Listen("tcp",":0222")
	if err != nil{
		fmt.Println(err)
		return
	}
...
func (this *ServerJ) ServidorPeliculas(servidor string, reply *Servidor) error { //Función para obtener los servidores disponibles
	var info Servidor 
	
	info.Tema = "Servidor PELICULAS"
	info.Protocolo = "tcp"
	info.Puerto = "0022"
