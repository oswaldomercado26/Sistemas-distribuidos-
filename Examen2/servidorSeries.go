...
func (this *Server) ServidorSeries(servidor string, reply *Servidor) error { //Función para obtener los servidores disponibles
	var info Servidor

	info.Tema = "Servidor SERIES"
	info.Protocolo = "tcp"
	info.Puerto = "0033"
